...
class Cart extends List {
  ...
  _updateCart(product) {
    ...
    block.querySelector('.product-price').textContent = `Цена: ${product.quantity * product.price} ₽`;
  }
  ...
  render() {
    return `<div class="cart-body" data-id="${this.id_product}">
                  <div class="cart-item-left">
                     ...
                     <tr>
                         <th>Имя: ${this.product_name}</th>
                         <th class="product-price">Цена: ${this.quantity * this.price} ₽</th>
                         <th class="product-quantity">Количество: ${this.quantity}</th>
                         <th><a href="#" class="del-btn" data-id="${this.id_product}">&times;</a></th>
                     </tr>
             </table>
             </div>
                  </div>
